...
<template>
    <DataTable ref="dt" v-model:selection="selectedProducts" :value="products" dataKey="id" :paginator="true" :rows="10"
        ...
        <Column field="category" header="Banco" sortable style="min-width: 15rem"></Column>
        <Column field="category" header="Tipo cuenta" sortable style="min-width: 15rem"></Column>
        <Column field="category" header="Estado" sortable style="min-width: 15rem"></Column>
        <Column field="category" header="Comprobacion" sortable style="min-width: 15rem"></Column>
    </DataTable>
</template>
