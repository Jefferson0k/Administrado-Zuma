...
<template>
    <DataTable ref="dt" v-model:selection="selectedProducts" :value="products" dataKey="id" :paginator="true" :rows="10"
        ...
        <Column field="name" header="Factura" sortable style="min-width: 16rem"></Column>
        ...
        <Column field="category" header="Tasa %" sortable style="min-width: 10rem"></Column>
        <Column field="category" header="Retorno Esperado" sortable style="min-width: 15rem"></Column>
        <Column field="category" header="Fecha" sortable style="min-width: 10rem"></Column>
