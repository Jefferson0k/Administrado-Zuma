...
<template>
    <DataTable ref="dt" v-model:selection="selectedProducts" :value="products" dataKey="id" :paginator="true" :rows="10"
        ...
        currentPageReportTemplate="Mostrando {first} a {last} de {totalRecords} depositos"
        class="p-datatable-sm">
        <template #header>
            <div class="flex flex-wrap gap-2 items-center justify-between">
                <h4 class="m-0">Depositos</h4>
                <IconField>
                    <InputIcon>
        ...
        <Column field="category" header="Numero de operacion" sortable style="min-width: 15rem"></Column>
        ...
        <Column field="category" header="voucher" sortable style="min-width: 15rem"></Column>
