    ...
    >
        <div v-if="facturaData" class="p-4">
            ...
            <div class="mb-4 text-center">
                ...
                <p class="text-lg font-medium mb-2">¿Estás seguro que deseas pausar esta factura?</p>
                <p class="text-sm">Esta acción cambiará el estado de la factura a "En Standby"</p>
            </div>
            <div class="">
...
const onConfirm = async () => {
    ...
    try {
        ...
        const response = await axios.patch(`/invoices/${props.facturaId}/standby`);
