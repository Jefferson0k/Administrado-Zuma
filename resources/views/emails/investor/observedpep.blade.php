...
<head>
  ...
  <style>
    ...
    .muted { color:#374151; }
    ol { padding-left: 18px; margin: 0 0 14px 0; }
    li { margin: 0 0 6px 0; }
  </style>
</head>
        ...
        <tr>
          <td style="padding:0 32px 6px 32px; color:#111827; font:400 14px/22px system-ui,-apple-system,Segoe UI,Roboto,Ubuntu;">
            ...
            <p class="muted" style="margin:0 0 12px 0;">
              En tu registro indicaste que eres <strong>Persona Expuesta Políticamente (PEP)</strong> o que tienes relación con un familiar que lo es.
            </p>
