          ...
          <tr>
            <td style="padding:0 32px 6px 32px;color:#111827;font:400 14px/22px system-ui,-apple-system,Segoe UI,Roboto,Ubuntu;">
              ...
              <p style="text-align:center;margin:18px 0 22px 0;">
                <a href="{{ $ctaUrl }}" class="btn" style="background: {{ $ctaColor }}; box-shadow:0 2px 0 rgba(0,0,0,.12);">
                  Subir nueva foto
                </a>
              </p>

              <p style="margin:0 0 12px 0;color:#374151;">
                Este proceso es 100% seguro y tiene como objetivo proteger tu información y garantizar que solo el titular tenga acceso a la cuenta.
              </p>
          ...
          <tr>
            <td style="padding:20px 24px;text-align:center;">
              ...
              <p style="margin:0 0 10px 0;">
                <a href="{{ $prefsUrl }}" style="color:#A3A7AD;font:500 12px/18px system-ui,-apple-system,Segoe UI,Roboto,Ubuntu;">Gestionar preferencias</a>
              </p>
