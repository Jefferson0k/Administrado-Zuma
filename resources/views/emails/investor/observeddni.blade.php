  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
      <td style="background: {{ $brandPrimary }}; padding:18px 0; text-align:center;">
        <span style="font:700 30px/1 sans-serif;color:#000;letter-spacing:.5px;">{{ $appName }}</span>
      </td>
    </tr>
        ...
        <table class="container" role="presentation" width="640" cellspacing="0" cellpadding="0" border="0" style="width:640px;max-width:640px;background:#FFFFFF;margin:0 auto;">
          <tr>
            <td style="padding:28px 32px 8px 32px;text-align:center;">
              <!-- Doc with X icon (inline SVG for email safety) -->
              <div style="margin-bottom:8px;">
                <svg width="66" height="66" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:inline-block;">
                  <path d="M14 2H7a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7l-5-5z" stroke="#111827" stroke-width="1.5" fill="none"/>
                  <path d="M14 2v5h5" stroke="#111827" stroke-width="1.5" fill="none"/>
                  <path d="M9 14l6 6M15 14l-6 6" stroke="#EF4444" stroke-width="1.8" />
                </svg>
              </div>
          ...
          <tr>
            <td style="padding:0 32px 6px 32px;color:#111827;font:400 14px/22px system-ui,-apple-system,Segoe UI,Roboto,Ubuntu;">
              ...
              <p style="text-align:center;margin:18px 0 22px 0;">
                <a href="{{ $whatsappUrl }}" class="btn" style="background:{{ $brandButton }};box-shadow:0 2px 0 rgba(0,0,0,.12);">
                  WhatsApp ZUMA
                </a>
              </p>
    ...
    <tr>
      <td align="center" style="padding:0 0 24px 0;">
        <table class="container" role="presentation" width="640" cellspacing="0" cellpadding="0" border="0" style="width:640px;max-width:640px;background:#0B0C0E;color:#E5E7EB;">
          <tr>
