@php
    ...
    $brandButton = '#1ab256';   // verde WhatsApp
    $logoUrl = $logoUrl ?? '';
                    ...
                    <tr>
                        <td
                            ...
                            <p style="margin:0 0 12px 0;color:#374151;">
                                Al revisar el documento de identidad (DNI/CE) que adjuntaste, encontramos que no cumple
                                con los requisitos de validación porque:
                            </p>
                            ...
                            <p style="margin:0 0 14px 0;color:#111827;font-weight:700;">
                                En breve uno de nuestros asesores se pondrá en contacto contigo por
                                <strong>WhatsApp</strong> para apoyarte en el proceso y resolver cualquier duda que
                                tengas.
                            </p>
                            ...
                            <p style="margin:0 0 12px 0;color:#374151;">
                                Este proceso es 100% seguro y tiene como objetivo proteger tu información y garantizar
                                que solo el titular tenga acceso a la cuenta.
                            </p>

                            <p style="margin:0;color:#111827;">Gracias por tu colaboración,<br>El equipo de
                                {{ $appName }}</p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font:500 13px/18px system-ui,-apple-system,Segoe UI,Roboto,Ubuntu;color:#111827;">
