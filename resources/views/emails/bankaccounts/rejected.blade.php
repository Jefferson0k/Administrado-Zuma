@php
    ...
    $title = $title ?? 'Cuenta bancaria rechazada';
    ...
    $bankAccountAlias = $bankAccount?->alias ?? 'tu alias';
                    ...
                    <tr>
                        <td class="darkmode-text"
                            ...
                            <p style="color:#374151;font-size:15px;text-align:justify;max-width:520px;margin:0 auto 12px;">
                                ...
                                Lamentamos informarte que tu cuenta bancaria con alias {{ $bankAccountAlias }} ha sido rechazada.
                                Por favor verifica tus datos y vuelve a enviarlos para validación.
                            </p>
                            ...
                            <p style="color:#111827;font-size:13px;margin-top:18px;">Agradecemos tu paciencia y
                                confianza durante este proceso. <br>El equipo de
                                {{ $appName }}
                            </p>
