@php
    ...
    $title = $title ?? 'Cuenta bancaria aprobada';
    ...
    $bankAccountAlias = $bankAccountAlias ?? 'tu alias';
                    ...
                    <tr>
                        <td class="darkmode-text"
                            ...
                            <p style="color:#374151;font-size:15px;text-align:justify;max-width:520px;margin:0 auto 12px;">
                                ...
                                Tu cuenta de banco del {{ $bankAccountbank }} con alias {{ $bankAccountAlias }} en {{ $moneda }} ha sido validada.
                              Realiza un depósito y empieza a invertir.
                            </p>
