@php
    ...
    $title = $title ?? 'Cuenta bancaria para invertir pendiente de validación';
                    ...
                    <tr>
                        <td class="darkmode-text"
                            ...
                            <p style="color:#374151;font-size:15px;text-align:justify;max-width:520px;margin:0 auto 12px;">
                                ...
                                Hemos recibido la información de tu cuenta bancaria y actualmente se encuentra
                                <strong>en proceso de validación.</strong>
                            </p>

                            <p style="color:#374151;font-size:15px;text-align:justify;max-width:520px;margin:0 auto 12px;">
                                Una vez completada la revisión, te notificaremos por correo electrónico el resultado de
                                la validación para que puedas continuar con tus operaciones en la plataforma. </p>
                            ...
                            <p style="color:#111827;font-size:13px;margin-top:18px;">Agradecemos tu paciencia y confianza durante este proceso. <br>El equipo de
                                {{ $appName }}
                            </p>
