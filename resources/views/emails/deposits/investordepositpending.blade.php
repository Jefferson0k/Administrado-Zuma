@php
    ...
    $title = $title ?? 'Depósito pendiente de validación';
                    ...
                    <tr>
                        <td class="darkmode-text"
                            ...
                            <p style="color:#374151;font-size:15px;text-align:justify;max-width:520px;margin:0 auto 12px;">
                                ...
                                Hemos recibido la información de tu depósito y actualmente se encuentra
                                <strong>en proceso de validación</strong> por parte de nuestro equipo.
                            </p>
