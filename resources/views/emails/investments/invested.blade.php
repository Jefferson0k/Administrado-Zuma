@php
    ...
    $title = $title ?? 'Operación recibida';
                    ...
                    <tr>
                        <td class="darkmode-text"
                            ...
                            <p style="color:#374151;font-size:15px;text-align:justify;max-width:520px;margin:0 auto 12px;">
                                ...
                                Tu inversión se registró correctamente.
                            </p>
                            ...
                            <p style="color:#374151;font-size:15px;text-align:justify;max-width:520px;margin:0 auto 12px;">
                             ...
                             <p style="color:#374151;font-size:15px;text-align:justify;max-width:520px;margin:0 auto 12px;">
                                <strong>Fecha de la inversión: </strong>{{ $fecha }}
                             </p>
                           


                            <p style="text-align:center;margin:18px 0 22px 0;">
                                <a href="{{ $ctaUrl .'/factoring/mis-inversiones' }}" class="btn"
