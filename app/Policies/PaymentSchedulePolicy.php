...
class PaymentSchedulePolicy
{
    ...
    {
        return $user->can('ver calendario de pagos');
    }
    ...
    {
        return $user->can('crear calendario de pagos');
    }
    ...
    {
        return $user->can('editar calendario de pagos');
    }
    ...
    {
        return $user->can('eliminar calendario de pagos');
    }
