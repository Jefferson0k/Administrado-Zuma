...
class DepositObservedSource extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('ZUMA - Tu depósito no pudo validarse, cuenta de origen incorrecta')
            ->view('emails.deposits.source_observed', [
                'appName'      => $appName,
