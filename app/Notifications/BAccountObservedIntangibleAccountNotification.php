...
class BAccountObservedIntangibleAccountNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('ZUMA - Verificación de tu cuenta bancaria registrada')
            ->view('emails.bankaccounts.intangible_account_verification', [
                'appName'      => $appName,
