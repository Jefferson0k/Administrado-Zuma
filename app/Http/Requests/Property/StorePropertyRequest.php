...
class StorePropertyRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            // Mensajes para propiedades individuales
            ...
            'properties.*.imagenes.*.required' => 'Cada imagen es obligatoria.',
     ...
     * Los mutators de los modelos se encargarán de convertir a centavos
     */
    protected function prepareForValidation(): void
    {
        // NO limpiar valores monetarios aquí - los mutators del modelo se encargarán
        // Solo asegurarse de que sean numéricos
        ...
        // Para propiedades, solo convertir a float, los mutators harán la conversión a centavos
        if ($this->has('properties') && is_array($this->input('properties'))) {
            ...
            foreach ($properties as $index => $property) {
                ...
                // Estos campos no se usan en Property, pero los limpiamos por si acaso
