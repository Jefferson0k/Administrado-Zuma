...
return new class extends Migration
{
    ...
    {
        Schema::create('history_aprobadores_withdraws', function (Blueprint $table) {
            $table->id();
            $table->foreignUlid('withdraw_id')->nullable()->constrained('withdraws')->nullOnDelete();
    ...
    {
        Schema::dropIfExists('history_aprobadores_withdraws');
    }
};
